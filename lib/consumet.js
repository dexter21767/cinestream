...
const EpisodeCache = new NodeCache({ stdTTL: (0.5 * 60 * 60), checkperiod: (0.5 * 60 * 60) });
const InfoCache = new NodeCache({ stdTTL: (0.5 * 60 * 60), checkperiod: (0.5 * 60 * 60) });
const SearchCache = new NodeCache({ stdTTL: (0.5 * 60 * 60), checkperiod: (0.5 * 60 * 60) });
